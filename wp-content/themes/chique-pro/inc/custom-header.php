...
if ( ! function_exists( 'chique_header_media_text' ) ):
	...
	function chique_header_media_text() {
		...
		$inner_page_content_align = get_theme_mod( 'chique_header_media_inner_page_content_align', 'content-aligned-center');
		$inner_page_text_align    = get_theme_mod( 'chique_header_media_inner_page_text_align', 'text-aligned-center' );
		...
		if ( is_front_page() ) {
			...
			$classes[] = $inner_page_content_align;
			$classes[] = $inner_page_text_align;
		}
