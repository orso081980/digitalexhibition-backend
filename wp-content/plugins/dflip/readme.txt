...
Contributors: deip, dearhive, freemius
...
= 2.4.37: =
* Fix: Fix for CVE-2026-8625 (thumbnail title XSS)
* Fix: Fix for CVE-2026-8623 (logo option XSS)
* Improve: Security imporvements and cleanup.
* Fix: Fix for Query.ready not firing when script loads after DOM ready
...
= 2.4.19: =
* Add: Search Translation added
* Add: HashNavigation settings added
* Fix: Rotated Pages highlight
* Fix: Controls displayed in hidden mode
...
= 2.4.11: =
* Add: Calendar Mode
* Add: DearPDF Migration
* Add: Standard Plan(Cheaper/Basic) variant of DearFlip added
...
= 2.3.58: =
* Fix: Vulnerability (CVE-2024-11830)
* Improve: Freemius upgraded to v2.11.0

= 2.3.50: =
* Add: WP-rocket exclusion attribute for the dflip inline script

= 2.3.48: =
* Add: Pseudo Zoom - you can zoom multiple times extra without increasing the max texture size.
...
* Improve: RTL thumbs when the site is in RTL mode

= 2.3: =
* Add: (Beta)Direct support for PDF files in media. Flipbook posts are not compulsory now
* Add: DearPDF migration support (needs different plugin to migrate)
* Add: Category filter added in posts page
* Fix: PDF.js Vulnerability (CVE-2024-4367) fix
* Fix: Custom type shortcode fix
...
* Fix: PDF.js fallback to a stable version to support old browsers
...
= 2.1.183: =
* Improvement: jQuery compatibility improved
* Improvement: Autoplay improved
...
= 1.7.18: =
* Improvement: Zoom on scroll now affects lightbox and fullscreen. Normal embedded mode is skipped.
...
* Fix: Tabs support. 3D Flipbook now work properly inside tabs and popups
